...
Underwater conditions tend to be noisier than terrestrial conditions. These models were not trained to operate below -5dB SNR but they can still perform reasonable. Here you can find recordings of orcas from Orcasound and South-Alaska humpback whale recorded by Michelle Fournet. 

| Original | Biodenoising | Noisereduce |
|----------|--------------|-------------|
| <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/benchmark/orcasound_original.wav" type="audio/wav" controls="controls"></audio> | <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/others/orcasound_biodenoising.wav" type="audio/wav" controls="controls"></audio> | <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/others/orcasound_noisereduce.wav" type="audio/wav" controls="controls"></audio> |
| <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/others/sahw_original.wav" type="audio/wav" controls="controls"></audio> | <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/others/sahw_biodenoising.wav" type="audio/wav" controls="controls"></audio> | <audio src="https://storage.googleapis.com/esp-public-files/biodenoising/demo/others/sahw_noisereduce.wav" type="audio/wav" controls="controls"></audio> |
