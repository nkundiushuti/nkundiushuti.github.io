...
const card_html = openreview => {
    if (openreview.session == 'Platinum'){
        return `<div class="industry-card m-4 text-center">
          <a href="industry_${openreview.uid}.html" class="image-wrapper mb-3" style="display: flex; align-items: center; justify-content: center;">
            <img style="max-width: 100%;" src="static/images/sponsors/${openreview.uid}.webp" />
          </a>
          </div>`
      }
    if (openreview.session == 'Gold'){
        return `<div class="industry-card m-4 text-center">
          <a href="industry_${openreview.uid}.html" class="image-wrapper mb-3" style="display: flex; align-items: center; justify-content: center;">
            <img style="max-width: 70%;" src="static/images/sponsors/${openreview.uid}.webp" />
          </a>
          </div>`
      }
    if (openreview.session == 'Silver'){
        return `<div class="industry-card m-4 text-center">
          <a href="industry_${openreview.uid}.html" class="image-wrapper mb-3" style="display: flex; align-items: center; justify-content: center;">
            <img style="max-width: 50%;" src="static/images/sponsors/${openreview.uid}.webp" />
          </a>
          </div>`
      }
    if (openreview.session == 'Bronze'){
        return `<div class="industry-card m-4 text-center">
          <a href="industry_${openreview.uid}.html" class="image-wrapper mb-3" style="display: flex; align-items: center; justify-content: center;">
            <img style="max-width: 40%;" src="static/images/sponsors/${openreview.uid}.webp" />
          </a>
          </div>`
      }
}
